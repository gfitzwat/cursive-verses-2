...
// Max verse count per chapter per book (index 0 = book 0 = Genesis)
export const VERSE_COUNTS: number[][] = [
  [31,25,24,26,32,22,24,22,29,32,32,20,18,24,21,16,27,33,38,18,34,24,20,67,34,35,46,22,35,43,55,32,20,31,29,43,36,30,23,23,57,38,34,34,28,34,31,22,33,26],
  [22,25,22,31,23,30,25,32,35,29,10,51,22,31,27,36,16,27,25,26,36,31,33,18,40,37,21,43,46,38,18,35,23,35,35,38,29,31,43,38],
  [17,16,17,35,19,30,38,36,24,20,47,8,59,57,33,34,16,30,24,33,3,17,17,10,22,21,28],
...
export function maxVerses(bookIndex: number, chapterIndex: number): number {
  return VERSE_COUNTS[bookIndex]?.[chapterIndex] ?? 30;
}
